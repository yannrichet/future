...
_Remark_: asynchronous evaluation needs more than one "worker" to be setup (eg. `plan("multisession",workers=2)`). Otherwise, evene using lazy=FALSE will not allow a backend evaluation (whatever platform you use). 
