...
In next section, we will go through each of the above strategies and discuss what they have in common and how they differ.
...
> b
 ...
 16826  16916  16917 
```
which clearly show that `a` and `b` are resolved in the calling process (pid 16826) whereas the two nested futures (`b1` and `b2`) are resolved in two separate R processes (pids 16916 and 16917).
...
> b
 ...
 16919  16920  16922 
```
First, we see that both `a` and `b` are resolved in different processes (pids 16918 and 16919) than the calling process (pid 16826).  Second, the two nested futures (`b1` and `b2`) are resolved in yet two other R processes (pids 16920 and 16922).
